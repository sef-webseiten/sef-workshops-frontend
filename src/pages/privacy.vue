<template>
  <Layout class="text-text-gray">
    ...
    <p>Eric Feltgen
      ...
      <br>52074 Aachen
      <br>
      <br>Telefon: 0241 55705543
      <br>E-Mail: eric.feltgen@courz.de</p>
    ...
    <p>Zur Erbringung kostenpflichtiger Leistungen werden von uns zusätzliche Daten erfragt, wie z.B. Zahlungsangaben,
      um Ihre Bestellung ausführen zu können.</p>
    <h3>Rechtsgrundlage:</h3>
    ...
    <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig. Ohne die Bereitstellung Ihrer
      personenbezogenen Daten können wir Ihnen keinen Zugang auf unsere angebotenen Inhalte und Leistungen gewähren.</p>
    <p></p>
    <h2>Newsletter</h2>
    <h3>Art und Zweck der Verarbeitung:</h3>
...
h2 {
  @apply text-xl font-bold text-text-gray mb-3;
}
